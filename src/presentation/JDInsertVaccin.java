 ...
 * @author Super-Afg
 */
public class JDInsertVaccin extends javax.swing.JDialog {

    /**
     * Creates new form NewJDialog
     */
    public JDInsertVaccin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
//permet de corriger les probleme des quates pour les requettes SQL 
        String corrige = discrip.replaceAll("'", " ");

        if (titre != null && discrip != null) {

            boolean ok = daovac.insertVaccin(new Vaccin(titre, corrige));
