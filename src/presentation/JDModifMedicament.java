 ...
 * @author Super-Afg
 */
public class JDModifMedicament extends javax.swing.JDialog {

    /**
     * Creates new form NewJDialog
     */
    public JDModifMedicament(java.awt.Frame parent, boolean modal, Medicament med) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jtfTitre, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
  ...
  private void fillComponents(Medicament med) {
        jtfTitre.setText(med.getNom_m());
        jtaDiscription.setText(med.getDiscrip_m());

        id = med.getId_m();
    }
    private void btnokActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnokActionPerformed
        Medicament med = new Medicament(id, null, null);
        med.setNom_m(jtfTitre.getText());
        med.setDiscrip_m(jtaDiscription.getText());

        boolean ok = daomed.updateMedicament(med);
        if (!ok) {
